...
int main() {
    ...
    vector<vector<double>> orig_mt(N, vector<double>(M));
    ...
    cout << "Норма вектора невязки:" << vector_n(F, orig_mt, B2, B, Br, N) << endl;
    print_vec(Br);
    cout << "относительная погрешность:" << relative_error(F, orig_mt, B2, F2) << endl;
}